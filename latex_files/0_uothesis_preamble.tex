...
% Examples:
% \documentclass[dissertation]{uothesis}
% \documentclass[dissertation, apacite]{uothesis}
\documentclass[dissertation, final, approved, apacite, copyright]{uothesis2} % For final copies
